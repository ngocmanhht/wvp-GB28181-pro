  ...
  <div id="consoleResource" style="width: 100%; height: 100%; background: #FFFFFF; text-align: center">
    <div style="width: 50%;height: 50%; float:left; ">
      ...
      <div class="resourceInfo">
        Total number of devices:{{ deviceInfo.total }}<br>
        Number of online:{{ deviceInfo.online }}
      </div>
    </div>
    <div style="width: 50%;height: 50%; float:left; ">
      ...
      <div class="resourceInfo">
        Total number of channels:{{ channelInfo.total }}<br>
        Number of online:{{ channelInfo.online }}
      </div>
    </div>
    <div style="width: 50%;height: 50%; float:left; ">
      ...
      <div class="resourceInfo">
        Total number of push streams:{{ pushInfo.total }}<br>
        Number of online:{{ pushInfo.online }}
      </div>
    </div>
    <div style="width: 50%;height: 50%; float:left; ">
      ...
      <div class="resourceInfo">
        Total number of streaming agents:{{ proxyInfo.total }}<br>
        Number of online:{{ proxyInfo.online }}
      </div>
    </div>
  </div>
</template>
