<template>
  <div id="chooseChannel">
    <el-dialog v-if="showDialog" v-el-drag-dialog v-loading="loading" title="channel sharing" top="2rem" width="80%" :close-on-click-modal="false" :visible.sync="showDialog" :destroy-on-close="true" @close="close()">
