...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_indexes
        ...
        -- Clean possible duplicate data first
...
/*
* 20260417 will wvp_device_mobile_positionChanged from an exclusive national standard location record table to a location record table shared by general channels
*/
