...
update wvp_device set server_id = 'your servicesID';
update wvp_media_server set server_id = 'your servicesID';
update wvp_stream_proxy set server_id = 'your servicesID';
update wvp_cloud_record set server_id = 'your servicesID';
