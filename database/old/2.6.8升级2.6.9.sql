...
alter table device
    add COLUMN switch_primary_sub_stream bool default false comment 'Turn on the switch between main and sub-streams（0-Not open，1-Open) The currently known supported devices are Dahua, TP—all LINK series devices'
